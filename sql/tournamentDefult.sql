CREATE DATABASE `tournament_deff` /*!40100 DEFAULT CHARACTER SET utf8 */;

CREATE TABLE `tournament_deff`.`couples` (
...
CREATE TABLE `tournament_deff`.`judge_lines` (
...
CREATE TABLE `tournament_deff`.`judge_list` (
...
CREATE TABLE `tournament_deff`.`nomination_participants_list` (
...
CREATE TABLE `tournament_deff`.`nominations` (
...
CREATE TABLE `tournament_deff`.`roles` (
...
CREATE TABLE `tournament_deff`.`roles_assigment` (
...
CREATE TABLE `tournament_deff`.`section` (
  `sectionid` int(11) NOT NULL AUTO_INCREMENT,
  `section_index` int(11) NOT NULL,
  PRIMARY KEY (`sectionid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE `tournament_deff`.`set_participants_list` (
...
CREATE TABLE `tournament_deff`.`sets` (
...
CREATE TABLE `tournament_deff`.`tour_participants_list` (
  `tour_id` int(11) NOT NULL,
  `couple_id` int(11) NOT NULL,
...
CREATE TABLE `tournament_deff`.`tournaments` (
...
CREATE TABLE `tournament_deff`.`tours` (
...
CREATE TABLE `tournament_deff`.`user_views` (
...
CREATE TABLE `tournament_deff`.`users` (
...
CREATE TABLE `tournament_deff`.`views_assigment` (
